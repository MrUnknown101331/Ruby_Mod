...
public class FruitCrusherScreenHandler extends ScreenHandler {

    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final FruitCrusherBlockEntity blockEntity;
    public FluidStack fluidStack;

    public FruitCrusherScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
