...
public class FluidInjectorScreen extends HandledScreen<FluidInjectorScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(MechaniumMod.MOD_ID, "textures/gui/fluid_injector_gui.png");

    private EnergyInfoArea energyInfoArea;
    private FluidStackRenderer fluidStackRenderer;

    public FluidInjectorScreen(FluidInjectorScreenHandler handler, PlayerInventory inventory, Text title) {
